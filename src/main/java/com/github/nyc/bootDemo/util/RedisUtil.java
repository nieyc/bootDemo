...
public final class RedisUtil {
    ...
    public void setObj(String key, Object value) {
    	...
    	fastJsonRedisSerializer.serialize(value);
        jedisCluster.set(key.getBytes(), fastJsonRedisSerializer.serialize(value));
        LOGGER.debug("RedisUtil:set cache key={},value={}", key, value);
    }
    ...
    public Object getObj(String key) {
    	FastJsonRedisSerializer<Object> fastJsonRedisSerializer = new FastJsonRedisSerializer<Object>(Object.class);
    	byte[] b=jedisCluster.get(key.getBytes());
    	Object o=fastJsonRedisSerializer.deserialize(b);
    	return o;
    }
